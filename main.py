...
def main():
    ...
    try:
        ...
        application.add_handler(CommandHandler("pro", handlers.professional_strategies_command))
        application.add_handler(CommandHandler("bankroll", handlers.bankroll_command))
        application.add_handler(CommandHandler("live", handlers.live_monitor_command))
        application.add_handler(CommandHandler("scan", handlers.scan_all_command))
        application.add_handler(CommandHandler("fifa", handlers.fifa_command))
        application.add_handler(CommandHandler("edge", handlers.edge_command))
        application.add_handler(CommandHandler("insider", handlers.insider_command))
        application.add_handler(CommandHandler("horsesplus", handlers.horses_enhanced_command))
        application.add_handler(CommandHandler("multisport", handlers.multisport_command))
        ...
        application.add_handler(CommandHandler("horses", handlers.horses_command))
